...
Texture credits (NASA Blue Marble, LRO WAC Moon, Sentinel-2 cloudless, USDA NAIP, NASA star map) live in [`public/textures/ATTRIBUTION.txt`](public/textures/ATTRIBUTION.txt). Super Heavy Raptor bells use a CC-BY Sketchfab prototype — [`public/models/ATTRIBUTION.txt`](public/models/ATTRIBUTION.txt).

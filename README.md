...
- **Restricted n-body + Earth J₂** — craft integrated with **RK4** under **Earth + Moon** point-mass gravity, **solar tide** (residual about Earth), Earth **J₂** (WGS84 equatorial radius), and simple **exponential atmosphere / quadratic drag** below ~120 km geodetic height. Pad, splash, and low-altitude floors sit on the **WGS84 ellipsoid** (same figure as the visual globe).

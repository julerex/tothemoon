...
- **Super Heavy recovery** — detached booster is RK4-integrated on Earth μ + J₂ + drag after stage-out (boostback + landing burn booked on leftover prop). Landing burn starts ~5 km AGL at the public T+ mark; the last few km seat onto the chopsticks or the gulf floor

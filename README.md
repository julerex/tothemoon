...
- Mission: **Starbase pad** → powered ascent (due-east, *i* ≈ 26°) → LEO coast → impulsive TLI on an **LRO-style direct transfer** (near min-energy; meet the Moon near lunar distance, not past it) → guided braking / powered descent → **landed**

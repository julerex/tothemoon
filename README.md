...
- Mission: **Starbase pad** → powered ascent (due-east, *i* ≈ 26°) → LEO coast → impulsive TLI (**Apollo free-return**) → ballistic coast to a low perilune → guided braking / powered descent → **landed**

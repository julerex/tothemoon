...
Source: https://www.spacex.com/launches/starship-flight-13
...
- X webcast video id: `2077785645645209727` (https://x.com/i/broadcasts/2077785645645209727)
...
**Ship path (theater-grade, ballistic-first):** near-circular upper-stage
insert along the Starbase → Indian Ocean corridor; pure free coast (no
altitude-hold glide); single-engine **relight as a real retrograde deorbit**
(theater ~20 s vs public ~12 s demo); high-AoA belly drag/lift + bank toward
...
open, **5:45 p.m. CDT** — no time shift). Solar longitude matches that UTC.
Analytic Earth/Sun (not the July 2027 Horizons table). Sun directional light

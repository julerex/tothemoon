...
**Visuals:** entry plasma glow, belly-flop → engines-first attitude, Indian Ocean site beacon + spray (not lunar dust), Super Heavy Gulf recovery. Photorealism track **V13–V25 shipped** (hull/engine look through V22; **V23** pad T−5 aerial massing — tank farm, tubular Mechazilla, circular hardstand, lattice chopsticks; **V23.5** soft cryo vent puffs; **V24** hex OLM vs T− stills; **V25** axial launch exhaust stream + denser Mechazilla lattice). Highlight clips remain a look-reference; no numbered visual slice is queued ([VISUAL_REALISM.md](./VISUAL_REALISM.md)).

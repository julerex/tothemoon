...
export const GLOSSARY: readonly GlossaryEntry[] = [
  ...
  },
  {
    ...
    category: "vehicle",
    definition:
      "Booster engines re-light after stage separation to reverse downrange velocity toward the landing zone (chopsticks or offshore). Super Heavy recovery is integrated on the Earth force model. Chopsticks seats on the tower; Flight 13 gulf is a hard splash after a 10→8→5 landing-burn relight.",
  },
  {
    id: "booster-cam",
    term: "Booster",

...
export function createBodies(): Bodies {
  ...
  // Night city lights (emissive) — day side washed out by sun; night side glints
  const nightMap = new THREE.CanvasTexture(makeEarthNightLightsTexture(texSize));
